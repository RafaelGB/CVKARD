           ...
           <section id="main" class="container">  
                ...
                <div class="box">
                  <div class="row">
                    ...
                    <div class="3u 6u(narrower) 12u$(mobilep)" style="position:relative;">
                    ...
                    <div class="12u">
                      <div class ="select-wrapper">
                        <select name="cat_busqueda" id="cat_busqueda">
...
<footer id="footer">
      ...
      <ul class="copyright">
        <li>&copy; CVKard. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
      </ul>
    ...
    <!-- Scripts -->
      ...
      <script>
			 ...
			 $("input[name=tipo_busqueda]").change(function(){
			 	...
			 	{
				 	var valores={ '0':' -Buscar en-', '1':'C', '2':'Php','3':'Java'};
			 	...
			 	{
				 	var valores={ '0':' -Buscar en-', '1':'Diseño Web', '2':'Diseño PHP','3':'Diseño Java'};
				 	var selectedOption= '0';
				 	$("#DivOferta").show();
				 	$("#tabla_ofertas").show();
			 	...
			 	var valores={ '0':'-Buscar en-', '1':'Empresas', '2':'Trabajadores','3':'Ambos'};
			 	var selectedOption= '0';
			 	$("#tabla_usu").show();
				 }
